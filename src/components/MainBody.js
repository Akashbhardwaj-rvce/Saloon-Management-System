...
function MainBody(){
    ...
    const getdetails = async () => {
        const details = await fetch('http://localhost:5000/fetchallshop',{
            method:"GET",
        ...
        const getbarberdetails = async () => {
            const details = await fetch('http://localhost:5000/fetchbarbers',{
                method:"POST",
                headers:{'Content-Type':'application/json',
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-caption text-center mb-30">
                            ...
                            <div className="service-cap">
                                <h4><Link to={"/barbers"} state={{id:shop._id}}>{shop.barbername}</Link></h4>
                                ...
                                <h3>Contact <span className="text-success">{shop.barbercontact}</span></h3>
                                <h3>Address <span className="text-primary">{shop.address}</span></h3>
                            </div>
                        </div>
                    </div>
                    )})
                ...
                {  shops.map((shop) =>{ return(      
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-caption text-center mb-30">
                            ...
                            <div className="service-cap">
                                <h4><Link to={"/barbers"} state={{id:shop._id}}>{shop.shopname}</Link></h4>
                                <h3>Address <span className="text-primary">{shop.shopaddress}</span></h3>
                            </div>
                        </div>
                    </div>
                    )})
                ...
                {/* <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-caption text-center mb-30">
                            ...
                            <div className="service-cap">
                                <h4><Link to="/appointment">Stylish Hair Cut</Link></h4>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-caption active text-center mb-30">
                            ...
                            <div className="service-cap">
                                <h4><Link to="/appointment">Body Massege</Link></h4>
                                <p>Sorem spsum dolor sit amsectetur adipisclit, seddo eiusmod tempor incididunt ut laborea.</p>
                            </div>
                        </div>
                    </div> 
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="services-caption text-center mb-30">
                            ...
                            <div className="service-cap">
                                <h4><Link to="/appointment">Breard Style</Link></h4>
                                <p>Sorem spsum dolor sit amsectetur adipisclit, seddo eiusmod tempor incididunt ut laborea.</p>
                            </div>
                        </div>
                    </div>
